...
class DimDate(Base):
    ...
    month_abbr = Column(VARCHAR(10), nullable=False)
    day = Column(INTEGER, nullable=False)
    day_of_week = Column(INTEGER, nullable=False)
    day_name = Column(VARCHAR(20), nullable=False)
    day_abbr = Column(VARCHAR(10), nullable=False)
    ...
    quarter_name = Column(VARCHAR(20), nullable=False)
    year_month = Column(VARCHAR(10), nullable=False)
